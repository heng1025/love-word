...
describe("DictPanel component", (function () {
        test("renders correctly", (function () {
                TestBinding.ReactTestingLibrary.render(JsxRuntime.jsx(DictPanel.make, {
                          data: Fixture.dictData
                        }), undefined, undefined, undefined, undefined, undefined);
                var phonetic = React.screen.getByText("[ hә'lәu ]", undefined);
                var translation = React.screen.getByText("interj. 喂, 嘿", undefined);
                var tag = React.screen.getByText("zk", undefined);
                var tags = React.screen.getAllByRole("mark", undefined);
        ...
        test("renders empty", (function () {
                ...
                var phonetic = React.screen.queryByText("[ hә'lәu ]", undefined);
                var translation = React.screen.queryByText("interj. 喂, 嘿", undefined);
                var tag = React.screen.queryByText("zk", undefined);
                var tags = React.screen.queryAllByRole("mark", undefined);
        ...
        test("phonetic play / ended event", (async function () {
                ...
                var mockAudioInstance = mockAudioResults[0].value;
